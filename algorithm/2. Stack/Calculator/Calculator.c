...
void GetPostfix( char* InfixExpression, char* PostfixExpression ) //InfixExpression : 중위표시 , PostfixExpression : 후위표시 
{
    LinkedListStack* Stack; //스택 선언 : 

    char Token[32]; //토큰 32개
    int  Type = -1;// 타입
    ...
    while ( Position < Length )//토큰을 다 읽을 때 까지
    {
